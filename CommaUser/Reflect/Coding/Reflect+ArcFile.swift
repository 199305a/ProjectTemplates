...
extension Reflect{
    ...
    class func save(obj: AnyObject! , name: String, duration: TimeInterval) -> String{
        ...
        if duration > 0 {
            ...
            UserDefaults.standard.set(Date().timeIntervalSince1970, forKey: name)
    ...
    class func deleteReflectModel(name: String){ _ = save(obj: nil, name: name, duration: 0)}
    
    static func pathWithName(_ name: String) -> String{

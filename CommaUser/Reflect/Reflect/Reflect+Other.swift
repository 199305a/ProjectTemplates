...
extension String{
    ...
    func deleteSpecialStr()->String{
        ...
        return self.replacingOccurrencesOfString("Optional<", withString: "").replacingOccurrencesOfString(">", withString: "").replacingOccurrencesOfString("ImplicitlyUnwrapped", withString: "")
    }

...
extension ReflectType{
    ...
    class func makeClass(_ type: ReflectType) -> Any.Type {
        
        let arrayString = type.typeName
        
        let clsString = arrayString?.replacingOccurrencesOfString("ImplicitlyUnwrapped", withString: "").replacingOccurrencesOfString("Array<", withString: "").replacingOccurrencesOfString("Optional<", withString: "").replacingOccurrencesOfString(">", withString: "")
        
        var cls: Any.Type? = ClassFromString(clsString!)
